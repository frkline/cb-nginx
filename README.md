...
Basic server building block configuring nginx.

- SCM: https://github.com/frkline/cb-nginx
- Build: 

For more information, visit [cb-nginx](https://github.com/frkline/cb-nginx)
...
1. Clone the Repository  
  ...
  ```
  > git clone --recursive git@github.com:frkline/cb-nginx.git
  ```  
   
2. Initialize the Cookbook's Dependencies  

  ```
  > cd cb-nginx/cookbook  
  > bundle install
  ```
